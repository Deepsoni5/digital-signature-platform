                ...
                <div className="w-full max-w-md animate-in fade-in zoom-in duration-500">
                    <div className="flex justify-center mb-8">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-slate-500 dark:text-slate-400 text-sm">Sign in to continue to ESignVia</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-6 mt-4">
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400 font-medium animate-in fade-in slide-in-from-bottom-2 duration-700 delay-300">
                            ...
                            <Link href="/sign-up" className="text-indigo-600 dark:text-indigo-400 font-bold hover:text-indigo-700 transition-colors">
                                Sign up for free
                            </Link>
                        </p>
                    </div>
